...
SOPCINFO_FILE := C:/FPGA_Projects/ChronoClock_FPGA_Altera_DE1/TP1_montre.sopcinfo
...
# Design Name 
# setting SOPC_NAME is TP1_montre
SOPC_NAME := TP1_montre
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1001070
SOPC_SYSID_FLAG += --sidp=0x1001070
ELF_PATCH_FLAG  += --sidp 0x1001070

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1489879675
SOPC_SYSID_FLAG += --timestamp=1489879675
ELF_PATCH_FLAG  += --timestamp 1489879675
